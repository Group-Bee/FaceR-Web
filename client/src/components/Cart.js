      ...
      return (
        <li className="item"  style={{whiteSpace: 'nowrap'}}>
          <p style={{ textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden'}} className="p-item">
            ...
            &emsp;
                  <span style={{ float: 'right' }}>{element.price}&emsp;<button onClick={this.props.remove.bind(this, element)} style={{backgroundColor: 'salmon', borderRadius: '6px', float: 'right'}}>Remove</button></span>
          </p>
        </li>
      )
    })
      ...
      <div>
        <li className="nav-right" style={{ zIndex: '2' }}>
          <div style={{ backgroundColor: '#1a1a1a' }}>
            ...
            <i className="fa fa-shopping-cart fa-2x" aria-hidden="true" style={{cursor: 'auto'}}></i>
            &nbsp;        <button
        ...
        {(this.state.showCart && this.props.incart.length != 0) ?
          (<div className="mydrop" style={{ backgroundColor: 'white', color: 'black', position: 'absolute', zIndex: '100', borderTopLeftRadius: '6px', borderTopRightRadius: '6px' }}>
